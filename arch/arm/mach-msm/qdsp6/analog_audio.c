...
#if HUAWEI_HWID_L2(S7, S7200)
#define GPIO_SPK_PWN 		36			
#elif HUAWEI_HWID(S70)
#define GPIO_SPK_PWN 		19			
#else
...
{
	/* stereo pmic init */
	pmic_spkr_set_gain(LEFT_SPKR, SPKR_GAIN_PLUS08DB);
	pmic_spkr_set_gain(RIGHT_SPKR, SPKR_GAIN_PLUS08DB);
